...
public class Zinseszins {
	...
	public static void main(String[] args) {
		...
		System.out.println("Bitte geben Sie die Höhe des Kapitals ein.");
		...
		do {
			...
			//System.out.println("Das Kapital in Monat " + zeit + " beträgt " + kapital + " Euro.");
			zeit++;
		} while(zeit <=zeitraum);
		
		System.out.println("Laufzeit (in Jahren) des Sparvertrages: " + zeitraum);
		System.out.println("Wie viel Kapital (in Euro) möchten Sie anlegen: " + endkapital);
